...
function main(args)
    ...
    memoryTensor = zeros(nTimeSteps);

    # basisTogether = [basis0, basis1, basis1, basis1, basis1];
    ...
    open(OUTPUT_PATH * FILE_INFO * "_tensor_size_t.dat", "w") do file
        serialize(file, memoryTensor)
    end
