...
import MPSKit: DMRG2, expectation_value, find_groundstate
import MPSKitModels: FiniteChain, FiniteMPS, MPOHamiltonian, @mpoham, vertices
...
### MPO representation of operators
...
number_op_r_chain = @mpoham sum(number_op_r{i} for i in vertices(FiniteChain(L)))
